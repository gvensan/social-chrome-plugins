# YouTube Search Toolkit (Unofficial) — Privacy Policy

**Effective date:** 2026-05-11

YouTube Search Toolkit ("the extension") is an **independent third-party (unofficial)** browser extension that helps you compose, save, and launch YouTube search URLs from a side
...
- **Saved searches** — names, tags, and the search-input shape you
  composed (keywords, `sp=` filter preset, upload date, duration,
  etc.) plus the resulting youtube.com search URL.
- **Tags** — labels you attach to saved searches for organization.
- **Settings** — theme, display mode (popup vs side panel), default
  filter preset (`defaultPreset`), default landing view, open mode
