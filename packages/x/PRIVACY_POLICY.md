# X Search Toolkit (Unofficial) — Privacy Policy

**Effective date:** 2026-05-11

X Search Toolkit ("the extension") is an **independent third-party (unofficial)** browser extension that helps you compose, save, and launch X (formerly Twitter) advanced search
URLs from a side panel. This policy describes what data the extension
...
- **Saved searches** — names, tags, and the search-input shape you
  composed (keywords, operators, filters, etc.) plus the resulting
  x.com advanced search URL.
- **Tags** — labels you attach to saved searches for organization.
- **Settings** — theme, display mode (popup vs side panel), default
  search mode (`defaultSearchMode`: top, latest, people, photos,
  videos), default landing view, open mode (current tab vs new tab).
