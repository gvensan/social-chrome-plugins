# Hugging Face Search Toolkit (Unofficial) — Privacy Policy

**Effective date:** 2026-05-11

Hugging Face Search Toolkit ("the extension") is an **independent third-party (unofficial)** browser extension that helps you compose, save, and launch Hugging Face search URLs
...
- **Saved searches** — names, tags, and the search-input shape you
  composed (keywords, task, library, license, and other filters) plus
  the resulting huggingface.co Models, Datasets, or Spaces search URL.
- **Tags** — labels you attach to saved searches for organization.
- **Settings** — theme, display mode (popup vs side panel), default
  search type (`defaultSearchType`: models, datasets, spaces),
